...
public class Chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        GroupNameRef = FirebaseDatabase.getInstance().getReference().child("Groups").child(AppInfo.department).child(chatGroupName).child("messages");
        ...
        RootRef.child("Groups").child(AppInfo.department).child(chatGroupName).child("messages").addChildEventListener(new ChildEventListener() {
            @Override
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (downloadUri != null) {
                                ...
                                String message = MessageInputText.getText().toString();
                                    ...
                                    RootRef.child("Groups").child(AppInfo.department).child(chatGroupName).child("Info").child("last_message").setValue("Фото");
    ...
    private void sendMessageToDataBase() {
...

        {
            ...
            RootRef.child("Groups").child(AppInfo.department).child(chatGroupName).child("Info").child("last_message").setValue(message);
            GroupMessageKeyRef = GroupNameRef.child(messagekEY);
